...
INSERT INTO `<DB_PREFIX>vehicles` (`id`, `Make`, `Model`) VALUES
  ...
  (518, 'Western Company', 'Bagger'),
  (519, 'Western Company', 'Cliffhanger'),
  (520, 'Western Company', 'Daemon'),
  (521, 'Western Company', 'Daemon Custom'),
  (522, 'Western Company', 'Gargoyle'),
  (523, 'Western Company', 'Nightblade'),
  (524, 'Western Company', 'Police Bike'),
  (525, 'Western Company', 'Rat Bike'),
  (526, 'Western Company', 'Sovereign'),
  (527, 'Western Company', 'Wolfsbane'),
  (528, 'Western Company', 'Zombie Bobber'),
  (529, 'Western Company', 'Zombie Chopper'),
  (530, 'Willard', 'Faction'),
